...
plot x                                                  						lc rgbcolor hsv2rgb(  0/360.0,0.0,0.5)	title "ideal",\
     ...
     "zoe_r240_one_phase.csv" 			using ($2):($6)				with lines	lc rgbcolor hsv2rgb(270/360.0,0.5,1.0)	title "Scheinstrom R240 1P",\
     "zoe_r240_one_phase.csv"			using ($2):($27/$3)			with lines	lc rgbcolor hsv2rgb(270/360.0,1.0,1.0)	title "Wirkstrom R240 1P",\
     "zoe_r240_three_phases.csv" 		using ($2):($25)			with lines	lc rgbcolor hsv2rgb(300/360.0,0.5,1.0)	title "Scheinstrom R240 3P",\
     "zoe_r240_three_phases.csv"		using ($2):($27/($48/sqrt(3))/3)	with lines	lc rgbcolor hsv2rgb(300/360.0,1.0,1.0)	title "Wirkstrom R240 3P",\
     "mg4_one_phase_three_connected.csv"	using ($2):($6) 			with lines	lc rgbcolor hsv2rgb(330/360.0,0.5,1.0)	title "Scheinstrom MG4 1P",\
     "mg4_one_phase_three_connected.csv"	using ($2):($27/$3)			with lines	lc rgbcolor hsv2rgb(330/360.0,1.0,1.0)	title "Wirkstrom MG4 1P"
