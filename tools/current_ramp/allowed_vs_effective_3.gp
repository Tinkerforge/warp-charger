...
plot x 																										lc rgbcolor hsv2rgb(  0/360.0,0.0,0.5)	title "ideal",\
     ...
     "citroen_ec3_one_phase.csv" 							using ($2):($6)						with lines	lc rgbcolor hsv2rgb(340/360.0,0.5,1.0)	title "Scheinstrom Citroen eC3 1P",\
     "citroen_ec3_one_phase.csv" 							using ($2):($27/$3)					with lines	lc rgbcolor hsv2rgb(340/360.0,1.0,1.0)	title "Wirkstrom Citroen eC3 1P",\
     "citroen_ec3_three_phases.csv" 						using ($2):($25)					with lines	lc rgbcolor hsv2rgb(350/360.0,0.5,1.0)	title "Scheinstrom Citroen eC3 3P",\
     "citroen_ec3_three_phases.csv" 						using ($2):($27/$24/3)				with lines	lc rgbcolor hsv2rgb(350/360.0,1.0,1.0)	title "Wirkstrom Citroen eC3 3P"
