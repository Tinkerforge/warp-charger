...
26-05-27 Tinkerforge - Edelstahl - 2
    ...
    \subsubsection{Wandmontage}\label{wandmontage}26-05-27 Tinkerforge - Edelstahl - 2
	...
	notwendig. Im Webinterface der Wallbox unter unter \texttt{Energiemanagement}
	$\rightarrow$ \texttt{§14a EnWG}  kann das Verhalten der Wallbox auf
	das Steuersignal koniguriert werden.
	...
	\item[\color{red}rot] Es gibt mindestens einen Fehler. Eine Funktion ist korrekt am
	arbeiten.
	\end{description}
...
\includegraphics[width=.5\linewidth]{./img_warp4/badge-appstore.png}
    ...
    dargestellt. Bei den Varianten WARP4 Charger Smart und WARP4 Charger Pro
