...
\includegraphics[width=.5\linewidth]{./img_warp4/badge-appstore.png}
    ...
    \begin{tabular}{ll}
		...
		WARP-CON-2P-63A						& Schaltschütz 2 Pol, Hilfskontakt,\\
        ...
        \cmidrule(lr{0.5em}){1-2}
        WARP-FUSE-2A              			& Feinsicherung für WARP3 und WARP4                     \\
                                                                                                                                    & 5x\SI{20}{\milli\meter}, träge \SI{2}{\ampere}        \\
        \cmidrule(lr{0.5em}){1-2}
        WARP-NFC-STICKER					& NFC-Aufkleber                        \\
        \cmidrule(lr{0.5em}){1-2}
        WARP-3-4-DC-PROTECT		  	        & DC-Fehlerstromschutzmodul (6mA)\\
											& für WARP3 und WARP4                    \\
        \cmidrule(lr{0.5em}){1-2}
        WARP4-CASE-CS-SC 					& WARP4 Smart Gehäuse\\
											& mit Edelstahlfrontblende                        \\
        \cmidrule(lr{0.5em}){1-2}

        WARP4-CASE-CS-PC 					& WARP4 Smart Gehäuse\\
											& mit Edelstahlfrontblende DB703                        \\
        \cmidrule(lr{0.5em}){1-2}

        WARP4-CASE-CP-SS 					& WARP4 Pro Gehäuse\\
											& mit Edelstahlfrontblende                        \\
        \cmidrule(lr{0.5em}){1-2}

        WARP4-CASE-CP-PC 					& WARP4 Pro Gehäuse\\
											& mit Edelstahlfrontblende DB703                        \\
        \cmidrule(lr{0.5em}){1-2}

        WARP4-CABLE-HARNESS					& WARP4 Kabelsatz           \\
        							        & Smart und Pro           \\
        \cmidrule(lr{0.5em}){1-2}
        ...
        \cmidrule(lr{0.5em}){1-2}
        WARP4-PB-LED						& WARP4 Taster/LED Baugruppe inkl.\\
											& Fronttaster mit RGB LED, \\
											& Anschlusskabel, Befestigungsmaterial			\\
        \cmidrule(lr{0.5em}){1-2}
        ...
        6150								& Bricklet-Kabel                       \\
											...
											& Für NFC Bricklet Anschluss\\
        \cmidrule(lr{0.5em}){1-2}
        6193								& Bricklet-Kabel                       \\
                                            & \SI{30}{\centi\meter} (7p-7p)        \\
											& Für DC Protection Anschluss\\
        \bottomrule
    \end{tabular}
	}
