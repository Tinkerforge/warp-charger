...
\begin{multicols*}{2}
	...
	\begin{description}
	\item[\color{green}grün] Alle konfigurierten Funktionen sind fehlerfrei
	\item[\color{yellow}gelb] Es gibt mindestens eine Warnung
	\item[\color{red}rot] Es gibt mindestens einen Fehler. Eine Funktion arbeitet nicht
	korrekt.
	\end{description}
