...
\fancyhead{\colorbox{boxgray}{
    \makebox[\dimexpr\linewidth-2\fboxsep][l]{
        \includegraphics[height=1cm]{./img/resized/logo_transparent.pdf}\hfill\color{white}\Huge\raisebox{.5ex}{\thepage}
        }
    }
}
...
\begin{titlepage}
	...
	\colorbox{boxgray}{\makebox[\dimexpr\linewidth-2\fboxsep][c]{\includegraphics[width=0.6\textwidth]{./img/resized/logo_transparent}}} \vfill \textcolor{red}{Work in progress!} \vfill
...
\end{multicols*}
\includepdf[landscape=true]{./img/resized/bohrschablone.pdf}
\end{document}
