...
\begin{multicols*}{2}
	...
	angeschlossen. Zu diesem führen zwei Kabel: Ein zweipoliges
	...
	müssen diese Kabel getrennt werden. Dazu ist das zweipolige
	Stromversorgungskabel auf der Unterseite des Controllers auf dem
	Berührungsschutz auszustecken. Die Verbindung zum Ladecontroller wird
	am besten direkt an dem Hutschienenmodul gelöst. Das Bricklet-Kabel verfügt über
	...
	sind unbedingt ca. 12 Sekunden abzuwarten („Wallbox-LED blinkt sehr schnell“)
	...
	auf der Rückseite dieser Anleitung. Du kannst entweder der QR-Code des Aufklebers verwenden,
	...
	Falls die Wallbox sich zu einem versteckten Access Point verbinden soll, musst du den Netzwerkname selbst eingeben,
	...
	\begin{itemize}
		...
		\item \textbf{Topic-Präfix} Dieser Präfix wird allen Topics vorangestellt, die die Wallbox verwendet.
	...
	\end{itemize}
	Nachdem die Konfiguration gesetzt und der \enquote{MQTT aktivieren}-Schalter gesetzt ist, kann die Konfiguration gespeichert werden.
	...
	\begin{tabular}{ll}
		...
		113                                                                                                                      & ESP32 Brick                                                   \\
		\cmidrule(lr{0.5em}){1-2}
		\href{https://www.tinkerforge.com/de/shop/bricklets/rs485-bricklet.html}{277}                                            & RS 485 Bricklet                                               \\
		\cmidrule(lr{0.5em}){1-2}
		2159                                                                                                                     & EVSE Bricklet                                                 \\
		\cmidrule(lr{0.5em}){1-2}
	...
	\begin{minipage}{\linewidth}
		...
		\begin{description}[leftmargin=!,labelwidth=\widthof{\textbf{Fehlerstromerkennung}}]
			...
			\item[Zugangsverriegelung]
			      Schlüsselschalter / Webinterface / Konfigurierbare Ladezeiten~\footref{fn:1}
	...
	\end{tcolorbox}
	Dieser Aufkleber findet sich auch auf\\ der Innenseite der Deckel der Wallbox.
	\columnbreak
	...
	\end{tcolorbox}
	Dieser Aufkleber findet sich auch auf der Unterseite\\ der Wallbox.
\end{multicols*}
