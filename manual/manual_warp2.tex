...
\begin{multicols*}{2}
	...
	WARP Charger können auf verschiedenen Wegen vom Netzbetreiber herunter
	...
	\begin{description}
		...
		Modbus TCP geeignet.
		\item{Rundsteuerempfänger/Steuerbox} An den Abschalteingang innerhalb
		der Wallbox kann ein potentialfreier Kontakt angeschlossen werden. Dazu
		muss eine Steuerleitung vom Rundsteuerempfänger oder der Steuerbox des
		Netzbetreibers in die Wallbox gelegt werden.
