...
\begin{multicols*}{2}
	...
	Fortfahren mit Kapitel \fullref{ladestrom_schalter}.
	...
	nachzuziehen. Fortfahren mit Kapitel \fullref{ladestrom_schalter}.
	...
	Das Webinterface ist im Kapitel \fullref{webinterface} vollständig beschrieben.
	...
	Firmware-Update durchgeführt wird, ist unter dem Abschnitt \fullref{firmware-update}
	beschrieben.
	...
	Siehe Kapitel \fullref{interfaces}.

	\subsection{Benutzer}
	Siehe die Kapitel \fullref{user_management} und \fullref{NFC}.
	...
	dann für OCPP, MQTT oder in den WLAN Einstellungen genutzt werden. Ansonsten
	wird das \glqq ESP x509 Certificate Bundle\grqq~genutzt.

	\subsubsection{Zeitsynchronisierung}\label{ntp}
	Um im Ladetracker und dem Ereignis-Log die aktuelle Uhrzeit anzeigen zu
	können, kann der WARP Charger diese per NTP über
	...
	\fxnote{TODO Erik: Startphase + Spielraum besser erklären}
	...
	noch auf dem Werkszustand. Siehe Kapitel \fullref{ladestrom_schalter}.
	...
	\begin{minipage}{\linewidth} %use minipage to control footnote placement
		...
		werden. Achtung: den Hinweis in Kapitel \fullref{dcerrorhint} beachten!
	\end{minipage}
