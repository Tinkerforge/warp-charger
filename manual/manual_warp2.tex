...
\begin{multicols*}{2}
    ...
    und im Tabellenkalkulationsprogrammen kompatiblen CSV-Format
    ...
    droht ansonsten eine Korrosion der Kontakte des Typ-2-Steckers.
    ...
    des verbauten Stromzählers angezeigt.
    ...
    \begin{description}[leftmargin=0.5cm]
     ...
     \item[Energielimit] Setzt ein generelles Energielimit für Ladevorgänge (nur Pro Wallbox). Funktion analog zum Zeitlimit.
    ...
    \begin{enumerate}
        ...
        \item Klicke auf \enquote{Flash} Der Flash-Vorgang ist beendet, wenn die Status-LED des ESP32 Ethernet Brick beginnt blau zu blinken.
    ...
    \paragraph{Webinterface der Wallbox} Steht nur bei den Varianten Smart und
        Pro zur Verfügung. Die Statusseite gibt den Ladestatus, erlaubten Ladestrom und den Grund für eventuelle Limitierungen aus
    ...
    \begin{tabular}{lll}
        ...
        11.09.2023 & 2.1.1   & Hinweis EU-Messgeräte-          \\
                   ...
                   &         & hinzugefügt                     \\
        01.03.2024 & 2.2.0   & Aktualisierung Firmware 2.2.0   \\
        \bottomrule
    \end{tabular}
