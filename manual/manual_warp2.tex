...
\begin{multicols*}{2}
	...
	Untergrund. Der Schraubenkopfdurchmesser darf nicht mehr wie 
	...
	können als Beispiel Holzschrauben vom Typ
	$\SI{5,0} \times \SI{80}{\milli\meter}$ mit
	$\SI{8}\times\SI{50}{\milli\meter}$ verwendet werden.
	...
	Der eingestellte Ladestrom ergibt abhängig vom einphasigen oder dreiphasigen
	Anschluss der Wallbox die folgenden maximalen Ladeleistungen:

	\begin{tabular}{lll}
		%\toprule
		\textbf{Strom}            & \textbf{1 Phasen} & \textbf{3 Phasen} \\
		\cmidrule(lr{0.5em}){1-3}\\
		\SI{6}{\ampere}           & \SI{1.4}{\kilo\watt}                     &		\SI{4.1}{\kilo\watt}             \\
		\SI{10}{\ampere}          & \SI{2.3}{\kilo\watt}                     &		\SI{6.0}{\kilo\watt}             \\
		\SI{13}{\ampere}          & \SI{3.0}{\kilo\watt}                     &		\SI{9.0}{\kilo\watt}             \\
		\SI{16}{\ampere}          & \SI{3.7}{\kilo\watt}                     & 		\SI{11.0}{\kilo\watt}             \\
		\SI{20}{\ampere}          & \SI{4.6}{\kilo\watt}                     &		\SI{13.8}{\kilo\watt}             \\
		\SI{25}{\ampere}          & \SI{5.6}{\kilo\watt}                     &		\SI{17.3}{\kilo\watt}             \\
		\SI{32}{\ampere}          & \SI{7.4}{\kilo\watt}                     &		\SI{22.0}{\kilo\watt}             \\
		%\bottomrule
	\end{tabular}
	...
	\begin{enumerate}
		...
		Da verwendete Schema sollte auf beiden Kabelseiten identisch sein.
	...
	\begin{tabular}{ll}
		...
		\cmidrule(lr{0.5em}){1-2}
		\href{https://www.tinkerforge.com/de/shop/warp/warp2-spare-parts/warp-fuse-05a.html}{WARP-FUSE-0.5A}                        & \small{2x Feinsicherung 5x\SI{20}{\milli\meter}}              \\
		...
		\cmidrule(lr{0.5em}){1-2}
		\href{https://www.tinkerforge.com/de/shop/warp/warp2-spare-parts/warp2-nfc-karte.html}{WARP2-NFC-CARD}                      & WARP2 NFC Karten                                              \\
		                                                                                                                            & (3 Stück)                                                     \\
		\cmidrule(lr{0.5em}){1-2}
		\href{https://www.tinkerforge.com/de/shop/warp/warp2-spare-parts/warp2-screws.html}{WARP2-SCREWS}                           & WARP2 Schraubenset                                            \\
		\cmidrule(lr{0.5em}){1-2} 
		\href{https://www.tinkerforge.com/de/shop/warp/warp2-spare-parts/warp2-pb-led-set.html}{WARP2-PB-LED}                       & WARP2 Taster- /                                               \\
		                                                                                                                            & LED-Baugruppe                                                 \\
		\cmidrule(lr{0.5em}){1-2} 
