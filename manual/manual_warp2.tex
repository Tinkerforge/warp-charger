...
\begin{multicols*}{2}
	...
	\textbf{Zeitlimit} gibt die zur Verfügung stehende Restzeit für den
	...
	Ladevorgang an. Über die Drop Down Box kann die Einstellung geändert werden.
	Diese Einstellung ist nur für die Pro Wallboxen verfügbar.
	...
	\begin{itemize}
		\item Ladeprotokoll im Browser starten, Browserfenster geöffnet halten.
	...
	Seit Firmware 2.0.0 zeichnet der WARP Charger alle durchgeführten Ladevorgänge auf. Pro Ladevorgang werden die folgenden Informationen gespeichert:
	\begin{itemize}
	 \item Startdatum und Zeit des Ladevorgangs, falls Datum und Zeit bekannt sind. Siehe \fullref{ntp}.
	...
	\begin{description}
		...
		Pro zur Verfügung. Die Statusseite (siehe TODO) gibt den Ladestatus aus
		...
		Unterseite Ladestatus (siehe Todo). Hier kann auch ein Ladeprotokoll
