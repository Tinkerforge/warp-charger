...
\begin{multicols*}{2}
	...
	\textbf{OCPP-Verbindung} zeigt den aktuellen Status der Verbindung zum konfigurierten OCPP-Server an.
	...
	\begin{description}
		...
		\item[Benutzer] Falls die Benutzerautorisierung aktiviert ist blockiert diese Ladestromgrenze bis ein Benutzer den Ladevorgang durch ein NFC-Tag freigibt.
	...
	\subsubsection{Stromzähler (Nur Pro)}
