...
\begin{multicols*}{2}
    ...
    (Schaltschrank-Hutschienenmodul)\fxnote{$\leftarrow$ das raus?} mit dem Rundsteuerempfänger oder der
    ...
    \fxwarning{Beschreibungstexte fixen wenn das im WEM angepasst ist!}
    \begin{description}
