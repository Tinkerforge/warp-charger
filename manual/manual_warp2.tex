...
\begin{multicols*}{2}
    ...
    \begin{tabular}{lp{0.12\textwidth}rrr}
		\toprule
		\multicolumn{2}{l}{Schalterstellung} & Strom & 1-phasig & 3-phasig\\
		\midrule
	...
	\begin{enumerate}
		...
		\item[] % hack to move thie next item to the next page without changing the spacing of the previous items
