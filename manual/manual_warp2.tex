...
\begin{multicols*}{2}
	...
	Stromkosten erhältst. Es ist auch möglich eine Statistik
	bezogen auf die jeweiligen NFC-Tags zu erhalten. Damit ist es dann möglich
	eine Ladestatistik pro Nutzer aufzubauen. Diese Statistik kann als .CSV
	heruntergeladen und somit z.B. in Excel verarbeitet werden.
	...
	Die Einführung des Anschlusskabels kann dabei entweder von unten oder von
	...
	nicht gesondert erläutert. Gute Dokumentation dazu findet sich auf
	...
	Steuerungsmöglickeit von außen oder ein vollständiger Lese-/Schreibzugriff
	konfiguriert werden. Der \textbf{Port} über dem die Funktion bereit gestellt
	...
	\begin{itemize}
		...
		\item \textbf{Kompatibilität zu Bender CC613} Kompatible Registertabelle zum Bender CC613 Laderegler.
		\item \textbf{Kompatibilität zu Keba C Series} Kompatible Registertabelle zu Wallboxen der C Serie von Firma Keba.
	\end{itemize}

	Sollen Fremdgeräte den WARP Charger fernsteuern, kann ggf. eine der
	kompatiblen Registertabellen verwendet werden.

	Die WARP Charger Registertabelle findest du in Abschnitt \fullref{modbus_tcp_registertabelle}
	oder auf \rurl{https://warp-charger.com/api.html}{warp-charger.com/api.html}.
...
2100          & weitere Stromzähler-Werte               & float (x85)  & all\_values                                            \\
              & \tdesc{Siehe API-Dokumentation}                                                                                 \\ \cmidrule{2-4}
