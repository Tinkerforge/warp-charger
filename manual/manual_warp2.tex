...
\begin{multicols*}{2}
	...
	\begin{tabular}{ll}
		...
		\cmidrule(lr{0.5em}){1-2}
		\href{https://www.tinkerforge.com/de/shop/warp/warp2-spare-parts/warp-fuse-05a.html}{WARP-FUSE-0.5A}                        & \small{2x Feinsicherung 5x20mm}                               \\
		                                                                                                                            & mittelträge 0,5A                                              \\
		\cmidrule(lr{0.5em}){1-2}
		...
		\cmidrule(lr{0.5em}){1-2}
		\href{https://www.tinkerforge.com/de/shop/warp/warp2-spare-parts/warp2-dc-protect.html}{WARP2-DC-PROTECT}                   & WARP2 DC Fehler-                                              \\
		                                                                                                                            & \small{stromschutzmodul (6mA)}                                \\
		\cmidrule(lr{0.5em}){1-2}
	...
	\begin{tabular}{lll}
		...
		12.10.2021 & 1.1     & Ersatzteilliste verfollständigt \\
		\bottomrule
	\end{tabular}
	\newpage
	\pagestyle{empty}
