...
\begin{multicols*}{2}
	...
	der Wallbox auslesen und sie fernsteuern.
	...
	eine DC-Fehlerstromerkennungskalibrierung durch (siehe \ref{fast_blink} \enquote{Wallbox-LED blinkt sehr schnell}).
	...
	\subsubsection*{Wallbox-LED blinkt sehr schnell}\label{fast_blink}
