...
\begin{multicols*}{2}
	...
	In der Standardkonfiguration der Wallbox wird auf \SI{4300}{\watt} limitiert, wenn der Abschalteingang geschlossen ist. Dieses Verhalten kann im Webinterface unter \texttt{Wallbox} $\rightarrow$ \texttt{Ladeeinstellungen} angepasst werden.
    ...
    anschließend erneut hergestellt (Kabel aus- und wieder einstecken), oder der Ladevorgang über das Webinterface gestartet werden.
	...
	Das Verhalten bei einem Tastendruck kann im Webinterface der Wallbox
	konfiguriert werden.
    ...
    \begin{figure}[H]
        ...
        \caption*{EVSE Klemmblock-Belegung}
    \end{figure}
    ...
    \begin{minipage}{0.35\textwidth}
        Wenn die Verbindung mit dem Access-Point der Wallbox hergestellt ist, kannst das Webinterface
	...
	zwischen ein- und dreiphasiger Ladung \fxnote{In der ganzen Anleitung Ladung rauskicken?} umgeschaltet werden. Mit dieser Einstellung kann die Ladeleistung zwischen ca. \SI{1,4}{\kilo\watt}
    ...
    andere Wallboxen steuert. Hier kann, wenn kein PV-Überschussladen verwendet wird, der \textbf{Verfügbare Strom} des Lastmanagement-Verbunds
    ...
    \begin{description}[labelindent=0.5cm, leftmargin=0.5cm]
     ...
     \item[Energielimit] Setzt beim WARP Charger Pro \fxnote{3?} ein generelles Energielimit für Ladevorgänge. Diese Funktion wird analog zum Zeitlimit eingerichtet.
	 ...
	 reagiert werden soll. In der Standardkonfiguration der Wallbox wird auf \SI{4300}{\watt} limitiert, wenn der Abschalteingang geschlossen ist, siehe \fullref{s14enwg}.
    ...
    \fxnote{Die hälfte hier sind sätze, die andere nicht}
    \begin{description}[labelindent=0.5cm, leftmargin=0.5cm]
        ...
        \item[Typ-2-Ladekabel] Maximalstrom des Typ-2-Ladekabels.
        \item[Abschalteingang] Blockiert oder gibt den Ladevorgang je nach Konfiguration des Abschalteingangs.
        ...
        \item[Modbus TCP-Freigabe] Freigabe/Blockierung des Ladevorgangs bei aktivierter Modbus TCP-Schnittstelle.
	...
	\begin{itemize}
		...
		Wallboxen und sich selbst. Die anderen Wallboxen müssen dazu im
    ...
    \subsubsection{Zeitsynchronisierung}\label{ntp} \fxnote{Hier auch Echtzeituhr erklären}
	...
	\newpage
	\section{Photovoltaik-Überschussladen}\label{pv_charge} \fxnote{Lademodi erklären}
	...
	\begin{description}
		...
		\item[Min+PV: Mindestladeleistung] Mit dieser Einstellung wird festgelegt welche Leistung im \enquote{Min+PV}~Lademodus aus dem Netz bezogen werden darf.
    ...
    Lastmanagement-Unterseite vorgenommen. \fxnote{Das ist falsch!} \fxnote{Hier verweisen auf die Wallboxen-Unterseite}
    ...
    \begin{tabular}{ll}
        ...
        \cmidrule(lr{0.5em}){1-2}
        \href{https://www.tinkerforge.com/de/shop/warp/warp3-spare-parts/}{WARP3-METER-3PH-MID}										& Eltako DSZ15DZMOD-3x80A               \\
        ...
        \cmidrule(lr{0.5em}){1-2}
        \href{https://www.tinkerforge.com/de/shop/warp/warp3-spare-parts/}{WARP3-DC-PROTECT}										& WARP3 DC-Fehlerstrom-                      \\
                                                                                                                                    & schutzmodul (6mA)                    \\
        \cmidrule(lr{0.5em}){1-2}
        ...
        \href{https://www.tinkerforge.com/de/shop/warp/warp3-spare-parts/}{WARP3-CASE-PC}											& WARP3 Gehäuse mit\\
																																	...
																																	& pulverbeschichtet \\
        \cmidrule(lr{0.5em}){1-2}
        \href{https://www.tinkerforge.com/de/shop/warp/warp3-spare-parts/}{WARP3-CABLE-HARNESS}										& WARP3 Kabelbaum (Basic, Smart, Pro)           \\
        \cmidrule(lr{0.5em}){1-2}
        ...
        \cmidrule(lr{0.5em}){1-2}
        \href{https://www.tinkerforge.com/de/shop/warp/warp3-spare-parts/}{WARP3-ISO-SET}											& WARP3 EVSE/ESP Isolator Set\\
        \cmidrule(lr{0.5em}){1-2}
