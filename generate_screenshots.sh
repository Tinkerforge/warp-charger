...
python3 screenshot.py -o manual/img_warp2/resized/web_evse2.png -H $1 --crop -c '#sidebar-evse' -e '#evse' -l '#evse > div:nth-child(28)'
...
python3 screenshot.py -o manual/img_warp2/resized/web_status.png -H $1 -c '#sidebar-network-group' '#sidebar-system-group'
...
python3 screenshot.py -o manual/img_warp2/resized/web_modbus_tcp.png -H $1 --crop -c '#sidebar-modbus_tcp' -e '#modbus_tcp'
