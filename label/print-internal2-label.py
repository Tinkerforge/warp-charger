...
def print_internal2_label(internal_1, internal_2, internal_3, internal_4, internal_5, internal_6, copies, stdout):
    # check copies
...
def main():
    ...
    print_internal2_label(args.internal_1, args.internal_2, args.internal_3, args.internal_4, args.internal_5, args.internal_6, args.copies, args.stdout)
