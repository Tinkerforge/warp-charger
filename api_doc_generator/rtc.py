...
rtc = Module("rtc", "Zeiteinstellungen der Real-Time Clock", "Benötigt das Feature <a href=\"#features_nfc\"><code>\"rtc\"</code></a>.", "", Version.ANY, [
    Func("time", FuncType.CONFIGURATION, Elem.OBJECT("Die aktuelle Zeit auf der Real-Time Clock.", members={
    ...
    Func("config", FuncType.CONFIGURATION, Elem.OBJECT("Die Real-Time-Clock-Konfiguration.", members={
