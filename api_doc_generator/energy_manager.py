...
energy_manager = Module("energy_manager", "Energy-Manager-Konfiguration", "", "Das `energy_manager`-Modul verwaltet Zustand und Konfiguration des WARP Energy Manager Bricklets.", Version.WEM, [
