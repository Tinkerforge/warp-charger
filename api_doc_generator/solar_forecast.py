...
solar_forecast = Module("solar_forecast", "PV-Ertragsprogrnose", "", "Über das `solar_forecast`-Modul kann eine PV-Ertragsprognose konfiguriert und ausgelesen werden.", Version.WARP2 | Version.WARP3 | Version.WEMX, [
    ...
    Func("planes/X/state", FuncType.STATE, Elem.OBJECT("Status der PV-Flächen", members={
            "last_sync": Elem.INT("Ein Unix-Timestamp in <strong>Minuten</strong>, der angibt wann die PV-Ertragsprognose das letzte Mal aktualisiert wurden."),
            "last_check": Elem.INT("Ein Unix-Timestamp in <strong>Minuten</strong>, der angibt wann die PV-Ertragsprognose das letzte Mal abgefragt wurden."),
            "next_check": Elem.INT("Ein Unix-Timestamp in <strong>Minuten</strong>, der angibt wann die PV-Ertragsprognose das nächste Mal abgefragt werden."),
    ...
    Func("planes/X/config", FuncType.CONFIGURATION, Elem.OBJECT("", members={
        ...
        "name": Elem.STRING("Anzeige der PV-Fläche."),
    ...
    Func("planes/X/forecast", FuncType.STATE, Elem.OBJECT("", members={
        ...
        "resolution":  Elem.INT("Auflösung der PV-Ertragsprognose im `forecast`-Array.", constants=[
            Const(0, "15 Minuten"),
            Const(1, "60 Minuten"),
        ]),
