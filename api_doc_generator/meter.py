...
meter = Module("meter", T({'de': "Veraltete Stromzähler-API", 'en': "Legacy Electricity Meter API"}), T({'de': "Bei Neuentwicklungen stattdessen {{{mod_ref:meters}}} verwenden!", 'en': "Use {{{mod_ref:meters}}} for new developments instead!"}),
    ...
    Func("state", FuncType.CONFIGURATION, Elem.OBJECT(T({'de': "Der Zustand des Stromzählers.", 'en': "The state of the electricity meter."}), members={
            ...
            "type": Elem.INT(T({'de': "Typ des verbauten Stromzählers. Nicht jeder Stromzähler wird von jedem Gerät unterstützt!", 'en': "Type of the installed electricity meter. Not every meter is supported by every device!"}), constants=[
                ...
                Const(4, U("Eastron SDM72CTM"), Version.WARP2 | Version.WARP3 | Version.WARP4 | Version.WEMX),
                Const(5, U("Eastron SDM630MCT"), Version.WARP2 | Version.WARP3 | Version.WARP4 | Version.WEMX),
                Const(6, U("Eltako DSZ15DZMOD"), Version.WARP2 | Version.WARP3 | Version.WARP4 | Version.WEMX),
                Const(7, U("YTL DEM4A"), Version.WARP2 | Version.WARP3 | Version.WARP4 | Version.WEMX),
                Const(8, U("Lovato DMED341MID7ER"), Version.WARP2 | Version.WARP3 | Version.WARP4 | Version.WEMX),
                Const(9, U("Eltako DSZ16D[ZE]"), Version.WARP3 | Version.WARP4 | Version.WEMX),
                Const(10, U("Iskra WM3M4C"), Version.WARP2 | Version.WARP3 | Version.WARP4 | Version.WEMX),
            ])
        })
    ),
    ...
    Func("error_counters", FuncType.STATE, Elem.OBJECT(T({'de': "Fehlerzähler der Kommunikation mit dem Stromzähler.", 'en': "Error counters for communication with the electricity meter."}), members={
            ...
            "local_timeout": Elem.INT(U("Local Timeout"), version=Version.WARP2 | Version.WARP3 | Version.WARP4 | Version.WEMX),
            "global_timeout": Elem.INT(U("Global Timeout"), version=Version.WARP2 | Version.WARP3 | Version.WARP4 | Version.WEMX),
            "illegal_function": Elem.INT(U("Illegal Function"), version=Version.WARP2 | Version.WARP3 | Version.WARP4 | Version.WEMX),
            "illegal_data_access": Elem.INT(U("Illegal Data Access"), version=Version.WARP2 | Version.WARP3 | Version.WARP4 | Version.WEMX),
            "illegal_data_value": Elem.INT(U("Illegal Data Value"), version=Version.WARP2 | Version.WARP3 | Version.WARP4 | Version.WEMX),
            "slave_device_failure": Elem.INT(U("Slave Device Failure"), version=Version.WARP2 | Version.WARP3 | Version.WARP4 | Version.WEMX),
        })
    ),
