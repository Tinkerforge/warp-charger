...
ocpp = Module("ocpp", "OCPP-Verbindung", "", "", Version.WARP2 | Version.WARP3, [
    Func("config", FuncType.CONFIGURATION, Elem.OBJECT("Konfiguration der OCPP-Verbindung", members={
        ...
        "cert_id": Elem.INT("ID des TLS-Zertifikats, dass zum Aufbau einer TLS-verschlüsselten Verbindung verwendet werden soll.", constants=[
