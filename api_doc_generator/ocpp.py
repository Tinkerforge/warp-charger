...
ocpp = Module("ocpp", T({'de': "OCPP-Verbindung", 'en': "OCPP Connection"}), "", "", Version.WARP2 | Version.WARP3, [
    Func("config", FuncType.CONFIGURATION, Elem.OBJECT(T({'de': "Konfiguration der OCPP-Verbindung", 'en': "OCPP connection configuration"}), members={
        ...
        "identity": Elem.STRING(T({'de': "Identität der Wallbox. Wird an die Endpoint-URL angehangen und als Benutzername für die Autorisierung verwendet", 'en': "Identity of the wallbox. Appended to the endpoint URL and used as username for authorization"})),
