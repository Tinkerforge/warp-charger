...
\vspace{-0.2cm}
	...
	\begin{itemize}
		...
		\item 1x/2x Kabelhalterungen inkl. 4x M6x16mm Innensechskantschrauben
...
\vspace{-0.1cm}
	...
	linken Fußplatte der Ladesäule (siehe Foto). An SO/27063
dieser Schraube laufen alle Erdungsleitungen
	zusammen.
    ...
    \par
    Es liegt zusätzlich ein RJ45 Patchkabel bei. Dieses kann nach Entfernen des Gummieinsatzes
    durch die M25 Verschraubung geführt werden und ebenfalls an der Wallbox angeschlossen werden.
	\par
	...
	\begin{itemize}
		\item Anlage nur mit einem feuchten Tuch oder einem nicht aggressivem Reiniger abwischen (Anwendungshinweise des Herstellers beachten). Keine aggressiven Reinigungsmittel, Wachs oder Lösungsmittel verwenden.
