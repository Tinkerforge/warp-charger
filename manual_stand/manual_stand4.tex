...
\begin{titlepage}
	...
	\begin{center}
		\Huge
		WARP4 Ladesäule Betriebsanleitung\\\vspace{1cm}
		\large
...
\begin{multicols*}{2}
	...
	Die WARP4 Ladesäule kann, je nach Modell, mit einem oder zwei WARP4 Charger Wallboxen
	ausgestattet werden. Die Ladesäule besteht aus \SI{2.0}{\milli\meter}
...
\vspace{-0.2cm}
	...
	\begin{itemize}
		...
		\item Optional: Verteilergehäuse vorbestückt für eine oder zwei Wallboxen
				\begin{itemize}
				\item Verteilergehäuse mit Hutschiene, Klemmen, RJ45 Buchse
