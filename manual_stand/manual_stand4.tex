...
\begin{multicols*}{2}
	...
	einzelne Komponenten einfach ausgetauscht werden können. 
	Die nachfolgende Betriebsanleitung gibt dir	alle notwendigen Informationen zu Sicherheit, Montage, Installation, Betrieb
	und Wartung der Ladesäule.

	\subsection{Beschreibung}

	Die WARP4 Ladesäule ist in zwei Varianten verfügbar:
	Ausgelegt für die Montage für einen oder zwei WARP4 Charger Wallboxen.
	Die Ladesäule besteht aus \SI{2.0}{\milli\meter}
	verzinktem Stahl, dann in DB703 pulverbeschichtet. Mit der Schutzklasse IP54
...
\vspace{-0.2cm}
	...
	\begin{itemize}
		\item Ladesäule
		\item Rückseite (Oberes Teil)
		\item Rückseite (Unteres Teil)
		\item Montagehilfe bestehend aus:
			\begin{itemize}
				\item 2x Montagehilfe
				\item 4x M8 Schrauben
				\item 4x Unterlegscheiben
				\item 8x M8 Muttern
			\end{itemize}
		\item Schaltschrankschlüssel
		\item 1-2x Kabelhalterungen
		\item Optional: Verteilergehäuse vorbestückt für eine oder zwei Wallboxen
				\begin{itemize}
				\item Verteilergehäuse mit Hutschiene, Klemmen, RJ45
				Hutschienen-Buchse
				\item Erdungsanschlussleitung
				\item Wallboxanschlussleitung (1-2 Stück)
				\item RJ45 Patchkabel 1.5m (1-2 Stück)
			\end{itemize}
...
\vspace{-0.1cm}
	...
	\begin{minipage}{\linewidth}
		\begin{description}[leftmargin=!,labelwidth=\widthof{\textbf{WARP4 Charger}}]
			...
			\item[Materialstärke] \SI{2.0}{\milli\meter} (DB703)
			...
			\SI{25}{\kilo\gram} (DB703), jeweils ohne WARP4 Charger
			\item[Verriegelung]
			      Vierkant, wahlweise mit Schlössern\\ lieferbar
			\item[Lieferumfang] Ladesäule, Befestigungsmaterial,
			Verteilergehäuse (optional), Betriebsanleitung
		\end{description}
	\end{minipage}
