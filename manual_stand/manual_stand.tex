...
\begin{multicols*}{2}
	...
	richtigen Abstand positioniert, ermöglicht es dir das Betonfundament einfach
	vorzubereiten.
	...
	Die Ladesäule dient zur Aufnahme von WARP Charger Wallboxen auf einer freien
	Fläche, bei der eine Wandmontage nicht möglich oder nicht gewünscht ist. 
	Es dürfen ausschließlich WARP Charger
	...
	\begin{itemize}
		\item Aufnahme für eine WARP Charger Wallbox.
		\item Aufnahme für zwei WARP Charger Wallboxen.
	\end{itemize}

	Bei Variante 2 ist es nicht zulässig, nur eine Wallbox zu montieren und den anderen Platz leer zu lassen.
	...
	\begin{itemize}
		...
		der Abstand zwischen den einzelnen Ladesäulen mind. \SI{200}{\milli\meter} betragen.
	...
	\subsubsection{Montage des Ladesäule}
	...
	damit die Gewinde offen liegen. Anschließend kann der Stele mittig über den
