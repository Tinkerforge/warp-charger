...
\begin{titlepage}
	...
	\begin{center}
		...
		\today\\
		\vspace*{1cm}
		\includegraphics[width=0.5\linewidth]{./img_v2/energymanager_2_face_side_ready.png}
	\end{center}
    \vfill
   	\pagecolor{covergray}
...
\begin{multicols*}{2}
    ...
    Dazu bietet der WARP Energy Manager zwei Relais-Ausgänge, die für Spannungen bis zu
    \SI{125}{\volt AC} bzw. \SI{110}{\volt DC} und Ströme bis zu \SI{2}{\ampere} ausgelegt sind.
    ...
    \hint{Wärmepumpen, die an ihren SG-Ready-Eingängen \SI{230}{\volt AC} erwarten
    ...
    Schaltkontakt des Koppelrelais schaltet die von der Wärmepumpe benötigten \SI{230}{\volt AC}.}
	...
	\begin{tabularx}{\linewidth}{ll>{\raggedright\arraybackslash}X}
		...
		25.09.2026 & 1.0.1   & Spannungs- und Stromgrenzen der SG-Ready-Ausgänge sowie Hinweis auf Koppelrelais bei \SI{230}{\volt AC} ergänzt. \\
		\bottomrule
	\end{tabularx}
