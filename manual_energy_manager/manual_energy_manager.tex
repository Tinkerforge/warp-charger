...
\begin{multicols*}{2}
	...
	\end{description}
	\paragraph{Experteneinstellungen}\ \\
	...
	Mit der Einstellung \textbf{SDM630*/SDM72*} werden folgende Stromzähler
	unterstützt:
	\begin{itemize}
		\item Eastron SDM630
	...
	\begin{minipage}{\linewidth}
		...
		\begin{description}[leftmargin=!,labelwidth=\widthof{\textbf{statisches Lastmanagement}}]
			...
			\item[Eigenverbrauch] TBD \SI{1}{\watt}
			\item[Betriebstemperatur] \SI{0}{\celsius}
			      bis \SI{+30}{\celsius}
			\item[Schutzklasse] II
			\item[PV-Überschussladen] max. 10 WARP Charger\footnote{\label{fn:1} WARP
			Charger/WARP Charger 2 in Varianten Smart oder Pro}
