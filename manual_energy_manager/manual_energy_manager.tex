...
\begin{multicols*}{2}
	...
	Ansonsten wäre eine Ladung gar nicht möglich und die Leistung würde ins Netz 
	eingespeist, oder aber zusätzliche Leistung müsste aus dem Netz bezogen werden, 
	damit eine Ladung beginnen kann (Sicherstellung der minimalen Ladeleistung).
	...
	Verfügung stehen. Der Energiemanager verteilt diesen Strom dynamisch
	...
	andere Zwecke verwendet werden (konfigurierbar). Eingang~\textbf{3} steht immer
	...
	Kabel nicht direkt an den Energiemanager anzuschließen, sondern die Nutzung 
	des mitgelieferten RJ45-Winkeladapters zwischen Energiemanager und
	LAN-Kabel.
	...
	Energiemanagers. Somit erhältst du die neusten Funktionen und ggf. Bugfixes. Wie ein
	...
	Status angezeigt. Zu diesem zählt unter anderem der zugeordnete Ladestrom.
	...
	Die Funktion wird erst mit einem kommenden Firmwareupdate veröffentlicht.
	...
	In diesem Modus findet also garantiert ein Ladevorgang statt.
	...
	Automatisch ermittelte Wallboxen, die noch nicht dem Energiemanager
	...
	vornehmen, die interne SD Karte formatieren und diverse Debuginformationen
	...
	Im \textbf{Low-Level-Zustand} werden alle Zustände vom Energiemanager
	dargestellt.
	...
	Alternativ kannst du den Energiemanager (genauer: den verbauten ESP32 Ethernet
	Brick) neu flashen.
