...
\begin{multicols*}{2}
	...
	Funktionen der Firmware 1.0.1. Informationen zum dynamischen Lastmanagement
	...
	\hint{Es ist nur dann notwendig, ein Schütz zu installieren, wenn eine Phasenumschaltung erfolgen soll.
	Wenn keine Umschaltung erfolgen soll, können die Wallboxen ohne Schütz fest ein- oder dreiphasig angeschlossen werden.}
	...
	Wird der Zubehörartikel \textbf{WARP Energy Manager Phase Switcher}
