...
\begin{multicols*}{2}
	...
	zulässig. Jegliche Modifikation des Managers und ein unsachgemäßer Betrieb ist verboten. 
	...
	Der WARP Energy Manager darf nur in einem geeigneten Verteilerschrank
	installiert werden und ist vor Witterungseinflüssen zu schützen. Es sollte
	...
	möglich ist (Metallabschirmung).

	\subsubsection{Montage}\label{wandmontage}
