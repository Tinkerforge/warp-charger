...
[WARP Charger](/warp_charger/introduction.md) and [WARP Energy Manager](/warp_energy_manager/introduction.md) are based on the same software. The following settings are available for the WARP Charger 
