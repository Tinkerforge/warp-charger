...
- If no MQTT broker is present in the network yet, the adapter is configured as a "Server/Broker". Authentication is optional but recommended. The remaining settings can be left at their default values.
