...
With the WARP3 Charger, we offer the third generation of our high-quality and durable charger for charging your electric vehicle. The charger is "Made in Germany", meaning developed
...
![image](/img/warp3/front.png)

## Features

The WARP3 Charger offers the following features, depending on the variant:
...
![image](/img/warp3/warp3_basic_open.jpg)
...
charger is built into the electric vehicle. The vehicle decides whether it charges single-phase, two-phase or three-phase at the charger.
Each charger can be connected single-phase or three-phase and is
available in 11 kW and 22 kW variants. The 11kW and 22kW variants differ only in the conductor cross-section of the
Type 2 charging cable of the charger. The maximum charging current can be set via a configuration switch in the charger during installation by a qualified electrician
from 6 A to 16 A (three-phase 11 kW) or from 6 A to 32 A (three-phase 22 kW).

After inserting the Type 2 charging plug into the vehicle, the RGB LED on the front panel of the charger displays the vehicle's charging status. Inside the
LED ring there is a button.

### WARP3 Charger Smart

![image](/img/warp3/warp3_smart_open.jpg)
...
into the charger. The WARP3 Charger Smart's web interface can be accessed via WLAN or LAN. On this, you can
view the current charging status and make settings on the charger. For example, the charging behavior
...
![image](/img/warp3/warp3_pro_open.jpg)
...
All chargers are supplied with a permanently connected 5 m or 7.5 m charging cable with Type 2 plug. In
the standard version, all WARP3 Chargers are supplied without a connection cable (supply line to the charger). In
this case, a connection cable must be provided during installation and connected in the charger.
The connection cable can be routed either from the bottom or from the rear of the charger.
Optionally, each charger can be ordered with a connection cable already installed at the factory. Additionally,
