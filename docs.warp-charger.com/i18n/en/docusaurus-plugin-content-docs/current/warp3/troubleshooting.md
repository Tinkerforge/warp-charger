...
Spare parts for the WARP3 Charger [are available in our shop](https://shop.warp-charger.com/en/spare-parts/warp3-spare-parts.html):

| Article number | Component |
|-|-|
| WARP-CON-2P-63A | Contactor 2-pole, DIN rail, 63 A (2x) |
| WARP3-METER-3PH-MID | Eltako DSZ15DZMOD-3x80A bidirectional three-phase meter, 3 phases, RS485, MID-certified |
...
| WARP3-FUSE-2A | Fine fuse 5×20 mm, slow-blow 2 A |
| WARP-NFC-STICKER | NFC sticker |
| WARP3-DC-PROTECT | WARP3 DC residual current protection module (6 mA) |
| WARP3-CASE | WARP3 case with stainless steel front panel |
| WARP3-CASE-PC | WARP3 case with stainless steel front panel DB703, powder-coated |
| WARP3-CABLE-HARNESS | WARP3 cable harness (Basic, Smart, Pro) |
| WARP-DSZ15-CABLE | Connection cable for DSZ15 |
| WARP3-TERMINAL-BLOCKS | WARP3 terminal block assembly |
| WARP2-NFC-CARD | 3× WARP2/3 NFC cards |
| WARP3-PB-LED | Front button with RGB LED, connection cable, mounting material |
| WARP-RES-220 | Resistor 220 Ω (22 kW) |
| WARP-RES-680 | Resistor 680 Ω (11 kW) |
| 117 | WARP ESP32 Ethernet Brick |
| 2177 | EVSE Bricklet 3.5 |
| 286 | NFC Bricklet |
| 6150 | Bricklet cable 15 cm (7p-7p) |
| 6149 | Bricklet cable 6 cm (7p-7p) (2x) |
