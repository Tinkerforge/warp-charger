...
export const devices = [
  ...
  },
  {
    ...
    device: "Micro Inverter via ECU-R or ECU-C",
    connection: "SunSpec",
  ...
  {
    manufacturer: "Deye",
    device: "SUN Series Hybrid Inverter",
    connection: "Modbus/TCP",
  ...
  {
    manufacturer: "Fronius",
    device: "GEN24 and GEN24 Plus Series Hybrid Inverter (Storage)",
    connection: "Modbus/TCP",
    link: "/docs/compatible_devices/devices#fronius",
    grid: "-",
    pv: "-",
  ...
  {
    manufacturer: "Fronius",
    device: "Primo and Symo Series String Inverter",
    connection: "SunSpec",
    link: "/docs/compatible_devices/devices#fronius",
    grid: "x",
    pv: "x",
  ...
  {
    manufacturer: "Fronius",
    device: "Tauro Series String Inverter",
    connection: "SunSpec",
    link: "/docs/compatible_devices/devices#fronius",
    grid: "x",
    pv: "x",
  ...
  {
    manufacturer: "Fronius",
    device: "Verto Series String Inverter",
    connection: "SunSpec",
    link: "/docs/compatible_devices/devices#fronius",
    grid: "x",
    pv: "x",
  ...
  {
    manufacturer: "Goodwe",
    device: "EHB Series String Inverter",
    connection: "Modbus/TCP",
  ...
  {
    manufacturer: "Goodwe",
    device: "EH, EM, ES, ET, GW Hybrid Inverter",
    connection: "Modbus/TCP",
    link: "/docs/compatible_devices/devices#goodwe",
    grid: "x",
    pv: "x",
  ...
  {
    manufacturer: "Goodwe",
    device: "BT, SBP, BH Series Battery Inverter",
    connection: "Modbus/TCP",
    link: "/docs/compatible_devices/devices#goodwe",
    grid: "?",
    pv: "-",
  ...
  },
  {
    ...
    device: "HL-TPH10K Hybrid Inverter",
    connection: "Modbus/TCP",
  ...
  },
  {
    ...
    device: "Micro Inverter HMS/HMT via DTU-Pro-S",
    connection: "SunSpec",
    note: "Micro Inverter of the HMS and HMT Series",
  ...
  {
    manufacturer: "Huawei",
    device: "SmartLogger 3000",
    connection: "Modbus/TCP",
    link: "/docs/compatible_devices/devices#smartlogger-3000",
    grid: "x",
    pv: "x",
    battery: "-",
    load: "-",
  ...
  {
    manufacturer: "Huawei",
    device: "SUN2000 Hybrid Inverter",
    connection: "Modbus/TCP",
  ...
  },
  {
    ...
    device: "UMG Series",
    connection: "Modbus/TCP",
    link: "/docs/compatible_devices/devices#umg-serie",
    grid: "x",
    pv: "x",
    battery: "x",
    load: "x",
  ...
  {
    manufacturer: "Kaco",
    device: "Blueplanet Hybrid NH3 Hybrid Inverter",
    connection: "SunSpec",
    note: "Hybrid Inverter",
  ...
  {
    manufacturer: "Kaco",
    device: "Blueplanet NX3 and TL3 String Inverter",
    connection: "SunSpec",
    link: "/docs/compatible_devices/devices#kaco",
    grid: "-",
    pv: "x",
  ...
  },
  {
    ...
    device: "Power Home and Power Home Plus",
    connection: "Modbus/TCP",
  ...
  },
  {
    ...
    device: "SolarEdge Synergie PV Inverter",
    connection: "SunSpec",
  ...
  {
    manufacturer: "Solax",
    device: "X1 & X3 Mini Boost MIC and Pro",
    connection: "Modbus/TCP",
    link: "/docs/compatible_devices/devices#solax",
    grid: "x",
    pv: "x",
  ...
  },
  {
    ...
    device: "GX and connected devices",
    connection: "Modbus/TCP",
  ...
  {
    manufacturer: "Victron Energy",
    device: "EM540, ET340, ET112, EM24 Electricity Meter",
    connection: "Modbus/TCP",
    link: "/docs/compatible_devices/devices#victron-energy",
    grid: "x",
    pv: "x",
   ...
   <table role="table" class="sortable-table">
    ...
    <tbody>
        <tr>
            ...
            <td>
                <div class="meters">
                    <div>{text_to_bubble(data.grid,    "Grid",    false)}</div>
                    <div>{text_to_bubble(data.pv,      "PV",      false)}</div>
                    <div>{text_to_bubble(data.battery, "Storage", false)}</div>
                    <div>{text_to_bubble(data.load,    "Load",    false)}</div>
                </div>
            </td>
            <td>
                <div class="features">
...
export const columns = [
 {
    ...
    cell: ({ cell, row: { original } }) => (original.manufacturer != undefined || original.manufacturer == "" )?
      ...
      original.link != undefined ? (
        <a href={original.link}>More Information</a>
      ) : (
      "x"
      )
    ),
  ...
  },
  {
    ...
    cell: ({ cell, row: { original } }) => (
        <div style={{display: 'flex'}}>
            <div>{text_to_bubble(original.grid,    "Grid"   )}</div>
            <div>{text_to_bubble(original.pv,      "PV"     )}</div>
            <div>{text_to_bubble(original.battery, "Storage")}</div>
            <div>{text_to_bubble(original.load,    "Load"   )}</div>
        </div>
    ),
  },
  {
