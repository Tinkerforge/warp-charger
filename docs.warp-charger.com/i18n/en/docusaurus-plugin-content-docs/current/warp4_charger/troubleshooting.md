...
Error states are indicated by the charger through the LED in the front button in red. For the WARP4 Charger Smart and WARP4 Charger Pro variants, the web interface or the [Charging Status page](/webinterface/wallbox/charge_status.md) provides more information.
