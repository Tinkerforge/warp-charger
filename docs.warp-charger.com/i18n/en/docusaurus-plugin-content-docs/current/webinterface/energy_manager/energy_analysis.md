...
the data of the configured power meters internally. The recorded values can be
viewed on this page.

At the top right, you can switch from a **daily view** to a **monthly view**.
...
In the daily view, the power values of the configured power meters are displayed for the selected
...
in the future, so the dynamic electricity prices are not yet determined and no power meter readings are available.
