...
The first two rules set charge management configurations of the chargers controlled by the Energy Manager in their action, and the third rule switches one of the relays installed in the WARP Energy Manager as an action.
