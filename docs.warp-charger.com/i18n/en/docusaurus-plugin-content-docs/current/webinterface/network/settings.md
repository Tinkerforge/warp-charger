...
This page allows configuring the *hostname* of the [WARP Charger](@current-charger/introduction) or [WARP Energy Manager](@current-wem/introduction) for all
...
This simplifies, for example, the setup of a charge management cluster.
