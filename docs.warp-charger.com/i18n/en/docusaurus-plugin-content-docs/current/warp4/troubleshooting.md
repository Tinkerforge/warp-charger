...
Error states are indicated by the charger through the LED in the front button in red. The web interface or the [Charging Status page](/webinterface/wallbox/charge_status.md) provides more information.
...
accessed at http://10.0.0.1/recovery. With an existing connection to a network, the page can be reached at http://configured_hostname/recovery, e.g., http://warp4-ABC/recovery. On the recovery page, the charger can be
 ...
 * **Firmware incompatible:** Charge management requires compatible firmware on all participating chargers. The current firmware versions should be compatible with each other, even when WARP(1), WARP2, WARP3 and WARP4 Charger are used in a charge management network.
...
Spare parts for the WARP4 Charger [are available in our shop](https://shop.warp-charger.com/en/spare-parts/warp4-spare-parts.html):

| Article number | Component |
|-|-|
| WARP-CON-2P-63A | Contactor 2-pole, auxiliary contact, DIN rail, 63 A (2x) |
| WARP4-METER-3PH-MID | Iskra WM3M4 V2 MID meter |
...
| WARP-FUSE-2A | Fine fuse for WARP3 and WARP4, 5×20 mm, slow-blow 2 A |
| WARP-NFC-STICKER | NFC sticker |
| WARP-3-4-DC-PROTECT | DC residual current protection module (6 mA) for WARP3 and WARP4 |
| WARP4-CASE-CS-SC | WARP4 Smart case with stainless steel front panel |
| WARP4-CASE-CS-PC | WARP4 Smart case with stainless steel front panel DB703 |
| WARP4-CASE-CP-SC | WARP4 Pro case with stainless steel front panel |
| WARP4-CASE-CP-PC | WARP4 Pro case with stainless steel front panel DB703 |
| WARP4-CABLE-HARNESS | WARP4 cable harness Smart and Pro |
| WARP-WM3M4-CABLE | WARP meter cable for Iskra WM3M4 |
| WARP4-CS-DIN-RAIL | WARP4 Smart DIN rail set |
| WARP4-CP-DIN-RAIL | WARP4 Pro DIN rail set |
| WARP-NFC-CARD | WARP NFC cards (3 pcs) |
| WARP4-PB-LED | WARP4 button/LED assembly incl. front button with RGB LED, connection cable, mounting material |
| WARP4-ESP32-ETH | WARP ESP32 Ethernet Brick 2.3 |
| WARP4-EVSE | WARP EVSE Bricklet 4.4 |
| WARP4-PLC | WARP PLC 1.1 |
| WARP4-PCB-MECH | WARP4 PCB mechanics set |
| 286 | NFC Bricklet |
| 6150 | Bricklet cable 15 cm (7p-7p), for NFC Bricklet connection |
| 6193 | Bricklet cable 30 cm (7p-7p), for DC Protection connection |
