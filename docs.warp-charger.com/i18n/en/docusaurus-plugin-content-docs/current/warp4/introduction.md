...
This documentation describes the WARP4 Charger. The documentation for the older
generations [WARP3 Charger](/docs/warp3/introduction),
[WARP2 Charger](/docs/warp2/introduction) and [WARP1 Charger](/docs/warp1/introduction)
can be opened at any time using the device selector in the menu.
