...
<tbody>
    ...
    <tr>
        ...
        <td>
            <ul>
                ...
                <li>1: Eastron SDM72 (nur WARP1)</li>
    ...
    <tr>
        ...
        <td>float32 (85x)</td>
        <td>all_values</td>
        <td>Siehe <a href="/de/docs/interfaces/mqtt_http/api_reference/meter/#meter_all_values_any">API-Dokumentation</a></td>
    </tr>
    <tr>
        <td>3100</td>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            werden! Falls auch die Farbe gesetzt werden soll (nur WARP3),
