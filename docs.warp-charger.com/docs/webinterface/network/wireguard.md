...
Mit WireGuard kann der [WARP Charger](@current-charger/introduction) oder [WARP Energy Manager](@current-wem/introduction) mittels einer verschlüsselten Verbindung
...
Ist der [WARP Charger](@current-charger/introduction) oder [WARP Energy Manager](@current-wem/introduction) per WLAN (Accesspoint) oder LAN mittels Browser
