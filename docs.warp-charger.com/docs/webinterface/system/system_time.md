...
Um für die Aufzeichnung der Energiebilanz und das Ereignis-Log die aktuelle Uhrzeit zur Verfügung zu haben, kann der [WARP Charger](@current-charger/introduction) oder [WARP Energy Manager](@current-wem/introduction) diese per NTP
