...
Diese Dokumentation beschreibt den WARP Energy Manager 2.0. Die Dokumentation für die
ältere Generation [WARP Energy Manager 1.0](/docs/wem1/introduction) kann jederzeit über
die Geräteauswahl im Menü aufgerufen werden.
