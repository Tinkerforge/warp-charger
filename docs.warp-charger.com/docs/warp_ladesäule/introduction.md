...
Diese Dokumentation beschreibt das Vorgängermodell der [WARP4 Ladesäule](/warp4_stand/introduction.md).

Mit der WARP Ladesäule bieten wir eine hochwertige Montagemöglichkeit für unsere [WARP3 Charger](/warp3/introduction.md) Wallboxen. Es kann eine WARP Charger Wallbox auf der Vorderseite der Ladesäule montiert werden.
