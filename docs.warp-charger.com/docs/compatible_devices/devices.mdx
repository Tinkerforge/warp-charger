...
lässt sich über das Display des Wechselrichters unter "Settings", dann "Ethernet" konfigurieren und auch einsehen. Bei Anschluss direkt über den LAN Port des Wechselrichters
