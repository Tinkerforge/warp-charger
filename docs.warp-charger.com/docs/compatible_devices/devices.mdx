...
Es sieht zur Zeit so aus, als wenn die Anwendung dynamisches Lastmanagement (dLM) mit den von E3DC zur Verfügung gestellten Zählerwerten nicht möglich ist, da die Phasenströme fehlen.
...
Ein dynamisches Lastmanagement (dLM) scheint mit en Zählerdaten nicht möglich zu sein, da keine Phasenströme geliefert werden.
...
Nur in diesem Fall wird die Anwendung PV-Überschussladen (PVÜ) unterstützt.
