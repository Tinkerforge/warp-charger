...
Weitere Informationen wie dies funktioniert gibt es auf der Seite [Schnittstellen](/docs/compatible_devices/interfaces#api). und in der [Meters API](/docs/interfaces/mqtt_http/api_reference/meters).
