...
Daher stellen wir ein spezifisches E3DC Modbus/TCP Profil bereit. Um dieses nutzen zu können muss im Hauskraftwerk unter "Hauptmenü > Funktionen > Funktion Modbus" das Protokoll auf "E3/DC Simple-Mode" gestellt werden.
