...
***WARP Charger und WARP Energy Manager können direkt auf fremde Geräte zugreifen und Daten von diesen abrufen. Befinden sich die Geräte in einem gemeinsamen Netzwerk,
so kann meistens ein PV-Überschussladen oder ein dynamisches Lastmanagement OHNE zusätzliche Hardware realisiert werden!***
:::
