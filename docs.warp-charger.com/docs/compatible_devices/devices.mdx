...
Leider bietet Kaco über SunSpec anscheinend nur die Messung der Erzeugung (PV) auch wenn ein externer Stromzähler am Wechselrichter angeschlossen wurde. Auf die Zählerdaten haben wir also keinen Zugriff.
