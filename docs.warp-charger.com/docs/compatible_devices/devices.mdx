...
Wechselrichter der SUN2000 Serie (2kW - 215kW) und der SUN8000-500KTL können über das Huawei Smart Dongle (SmartDongle ab Firmware SPC124) mittels Modbus/TCP ausgelesen werden.
