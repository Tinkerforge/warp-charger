// This is the default tabs component,
// but with the li's style overwritten to allow the tab list to break.
...
function TabsContainer({className, children}: {className?: string; children: React.ReactNode}) {
  return (
